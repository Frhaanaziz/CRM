...
async function handleSubmit(event: FormSubmitEvent<ForgotPasswordType>) {
    try {
...
<template>
    <section class="p-32">
        ...
        <UForm :schema="forgotPasswordSchema" :state="state" class="mt-6 space-y-4" @submit="handleSubmit">
