...
<template>
    <div v-if="selectedRangeOption">
        ...
        <ReportSalesFunnel v-if="reportType === 'sales'" :range="selectedRangeOption?.value" />
        <ReportActivityOverview v-else-if="reportType === 'activity'" :range="selectedRangeOption?.value" />
        <ReportPerformanceComparison v-else-if="reportType === 'performance'" :range="selectedRangeOption?.value" />
    </div>
</template>
