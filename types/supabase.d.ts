    ...
    public: {
        ...
        Enums: {
            ...
            activity_types:
                ...
                | 'email'
                | 'assigned';
            close_reasons: 'pricing' | 'competition' | 'long sales cycle' | 'communication' | 'decision making' | 'others';
            company_statuses: 'new' | 'qualified' | 'disqualified';
            contact_statuses: 'new' | 'qualified' | 'disqualified';
            currencies: 'idr' | 'usd';
            disqualify_reasons: 'lost' | 'cannot contact' | 'no longer interested' | 'canceled';
            lead_statuses: 'new' | 'contacted' | 'qualified' | 'disqualified';
            method_name: 'email' | 'note' | 'call';
            opportunity_statuses: 'qualified' | 'proposal send' | 'contract send' | 'won' | 'lost';
